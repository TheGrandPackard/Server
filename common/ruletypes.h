...
RULE_INT(World, LatestExpansion, 99) // Sets the latest expansion for determining what content from the database and quest scripts will be used at runtime. 99 Will load latest content
